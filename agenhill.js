(function () {
  ...
  const I18N = {
    en: {
      'nav.home':'Home','nav.projects':'Projects','nav.mt5':'Crypto Indicators','nav.models':'3D Models','nav.apps':'Apps','nav.ai':'AI Lab','nav.contact':'Contact','nav.explore':'Explore Projects',
      'hero.pill':'Personal Digital Project Lab','hero.status':'Website currently under development','hero.lead':'Personal digital project lab featuring crypto indicators, trading bots, signal tools, arbitrage scanners, TradingView / MT5 tools, 3D models, apps and AI concepts. Some products are already available externally while new projects are still in development.','hero.btn1':'Available products','hero.btn2':'Development projects',
      'card.mt5':'Crypto Indicators','card.models':'3D Models','card.apps':'Android Apps','card.ai':'AI Tools','card.concepts':'Concept Projects','tag.external':'Available externally','tag.dev':'In development','tag.proto':'Prototype',
    ...
    ru: {
      ...
      'hero.pill':'Персональная цифровая лаборатория','hero.status':'Сайт находится в разработке','hero.lead':'Персональная цифровая лаборатория: крипто-индикаторы, торговые боты, сигнальные инструменты, арбитражные сканеры, TradingView / MT5 инструменты, 3D-модели, приложения и AI-концепты. Часть продуктов уже доступна на внешних площадках, а новые проекты всё ещё в разработке.','hero.btn1':'Доступные продукты','hero.btn2':'Проекты в разработке',
      'card.mt5':'Crypto-индикаторы','card.models':'3D Модели','card.apps':'Android Приложения','card.ai':'AI Инструменты','card.concepts':'Концепт проекты','tag.external':'Доступно внешне','tag.dev':'В разработке','tag.proto':'Прототип',
    ...
    de: {
      ...
      'hero.pill':'Persönliches digitales Projektlabor','hero.status':'Website befindet sich im Aufbau','hero.lead':'Persönliches digitales Projektlabor mit Crypto-Indikatoren, Trading-Bots, Signal-Tools, Arbitrage-Scannern, TradingView / MT5 Tools, 3D-Modellen, Apps und AI-Konzepten. Einige Produkte sind bereits extern verfügbar, während neue Projekte noch in Entwicklung sind.','hero.btn1':'Verfügbare Produkte','hero.btn2':'Projekte in Entwicklung',
      'card.mt5':'Crypto Indikatoren','card.models':'3D Modelle','card.apps':'Android Apps','card.ai':'AI Tools','card.concepts':'Konzeptprojekte','tag.external':'Extern verfügbar','tag.dev':'In Entwicklung','tag.proto':'Prototyp',
